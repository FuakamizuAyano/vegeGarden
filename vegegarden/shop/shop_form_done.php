...
<body style="background-color:#FFFFF0;text-align:center;">
    ...
    $honbun .= "\n";
    $honbun .= "〇〇県△△都××村123-4\n";
    $honbun .= "電話 090-6060-0707\n";
    $honbun .= "メール info@bejinouen.co.jp\n";
    $honbun .= "□□□□□□□□□□□□□□\n";
    ...
    $title = 'ご注文ありがとうございます。';
    $header = 'From: info@bejinouen.co.jp';
    $honbun = html_entity_decode($honbun, ENT_QUOTES, 'UTH-8');
    ...
    mb_language('Japanese');
    mb_send_mail('info@bejinouen.co.jp',$title, $honbun, $header);
